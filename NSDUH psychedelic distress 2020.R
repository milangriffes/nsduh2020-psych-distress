...
#Analysis variables: SPDYR = past-year serious psychological distress?; IRHALLUCREC = Hallucinogen recency
...
drdf <- NSDUH_2020[c("irhallucrec", "spdyr", "spdmon", "NEWRACE2", "AGE2", "irsex", 
